...
const ProjectDetailPage = () => {
  ...
  const { project, milestones, freelancers, loading, error, fetchProjectDetails } = useContext(ProjectContext);
  ...
  const handleHireFreelancer = () => {
    // Navigate to hire freelancer page
      ...
      project && !error && !loading && (
        <div className="max-w-4xl mx-auto p-6 mt-6 mb-4  bg-brand-gray-light shadow-lg rounded-lg border border-gray-300">
          <div className="flex justify-between mb-6">
            ...
            {project.status == 'in_progress' || project.status == 'open' &&  <button
              ...
              {project.status == 'in_progress' &&  <button
          ...
          <div className="mb-8">
            ...
            {/* Add buttons based on freelancer presence */}
            {freelancers.length === 0 ? (
               <div className="mt-8">
               <Link
         ...
         {project.status != 'open' && <div className="mb-4">
